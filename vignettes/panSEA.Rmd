...
output:
  ...
  vignette: >
    %\VignetteIndexEntry{Multi-omic Set Enrichment Analysis}
...
devtools::install_github("PNNL-CompBio/panSEA", build = FALSE)
```
